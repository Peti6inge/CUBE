    ...
    public void estKO(bool bombeExplose = true) // DONE
    {
        ...
        switch (type)
        {
            case Jeu.InvocationType.Bombe:
                ...
                ((Bombe)proprietaire.attaques[Features.AttaqueType.bombe]).setBombeNull();
                if (bombeExplose)
                    activerBombe();
                break;
            case Jeu.InvocationType.EspritElfique:
                ...
                (
                    (EspritElfique)proprietaire.attaques[Features.AttaqueType.espritElfique]
                ).setEspritElfiqueNull();
                break;
            case Jeu.InvocationType.Mouette:
                myCase.face.maJEmbrumage();
                proprietaire = isHost ? Jeu.piratitanHost : Jeu.piratitanClient;
                ((Mouette)proprietaire.attaques[Features.AttaqueType.mouette]).setMouetteNull();
                break;
            case Jeu.InvocationType.Crapeau:
                proprietaire = isHost ? Jeu.fantomageHost : Jeu.fantomageClient;
                ((Crapeau)proprietaire.attaques[Features.AttaqueType.crapeau]).setCrapeauNull();
                break;
        }
    }
